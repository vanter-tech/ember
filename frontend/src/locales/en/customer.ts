...
export const customer = {
  ...
  homeStep1Title: 'Scan or enter the code',
  homeStep1Body: 'Scan the table QR or type its 5-digit code.',
  homeStep2Title: 'Join with your group',
  homeStep2Body: 'Everyone at the table sees the same cart in real time.',
  homeStep3Title: 'Order and pay your share',
  homeStep3Body: 'Each person confirms their order and pays their part of the bill.',
  homeHelpTitle: 'Need help?',
  homeHelpBody:
    "If you can't join, ask the restaurant staff for the code or scan the table QR again.",
  homeHelpCta: 'Try again',
  bannerPickerTitle: 'Choose a background',
  bannerPickerDescription: 'Personalize your home background.',
  bannerPickerAria: 'Change the banner background',
  bannerEmber: 'Ember',
  bannerSunset: 'Sunset',
  bannerForest: 'Forest',
  bannerOcean: 'Ocean',
  ...
  qrJoinSignInHint: 'Keep your history and orders',
  qrJoinGuestHint: 'Order without creating an account',
  qrJoinOr: 'or',
  ...
  qrScannerDenied:
    "We couldn't access the camera. Allow the permission or use the 5-digit code.",
  qrScannerUnsupported: "This device or browser can't scan. Use the 5-digit code.",
