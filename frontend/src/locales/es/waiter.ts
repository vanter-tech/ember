export const waiter = {
  ...
  participantLeftLabel: '{{name}} ha salido de la mesa',
  ...
  expectedCashHint: 'Fondo + ventas en efectivo + entradas − salidas',
  openedAtLabel: 'Apertura',
  deadlineLabel: 'Límite',
  timeLeftLabel: '{{time}} restantes',
  ...
  refundedTotalLabel: 'Reembolsado en el turno',
  ...
  tableQrInfoLabel: 'Código y QR de la mesa',
  qrLoadingLabel: 'Generando código...',
  qrSavingLabel: 'Guardando',
  openTableGenerateQrButton: 'Abrir Mesa y Generar QR',
  seatNamesLabel: 'Nombres de los asientos (opcional)',
  seatNamePlaceholder: 'Asiento {{n}}',
  addSeatLabel: 'Agregar asiento',
  renameSeatTitle: 'Renombrar asiento',
  removeSeatTitle: 'Quitar asiento',
  seatNameInputLabel: 'Nombre del asiento',
  seatSaveButton: 'Guardar',
  seatRemoveConfirmButton: 'Quitar',
  removeSeatConfirm: '¿Quitar el asiento "{{name}}"? Sus productos en borrador se descartan.',
  seatAddedToast: 'Asiento agregado',
  seatRenamedToast: 'Asiento renombrado',
  seatRemovedToast: 'Asiento eliminado',
  seatErrorToast: 'No se pudo actualizar el asiento',
  renameBlockedBillExistsToast: 'Recalcula la cuenta antes de renombrar asientos',
  ...
  addItemUncategorized: 'Sin categoría',
  addItemCartHeading: 'Pedido de {{name}}',
  addItemEmptyCart: 'Todavía no hay platillos para este cliente.',
  addItemViewCartButton: 'Ver pedido',
  addItemRemoveLineAria: 'Eliminar {{name}}',
