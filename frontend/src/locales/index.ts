...
export const dictionaries = {
  es: { common: esCommon, auth: esAuth, customer: esCustomer, waiter: esWaiter, kitchen: esKitchen },
  en: { common: enCommon, auth: enAuth, customer: enCustomer, waiter: enWaiter, kitchen: enKitchen },
}
