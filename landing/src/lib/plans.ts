	...
	return [
		{
			...
			rows: [
				...
				{ label: t('ptable.r.floor'), values: [true, true, true, true] },
				{ label: t('ptable.r.split'), values: [true, true, true, true] },
				{ label: t('ptable.r.cashclose'), values: [false, true, true, true] },
				{ label: t('ptable.r.print'), values: [true, true, true, true] },
			],
		},
		{
			...
			rows: [
				...
				{ label: t('ptable.r.advanced'), values: [true, true, true, true] },
		...
		},
		{
			...
			rows: [
				{ label: t('ptable.r.staff'), values: [true, true, true, true] },
