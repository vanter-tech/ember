...
export const ui: Record<Lang, Record<string, string>> = {
	es: {
		...
		'plan.starter.f2': 'Cierre de caja por turno',
		'plan.starter.f3': 'Roles de cocina y contabilidad',
		...
		'plan.pro.f2': 'Exportación de reportes',
		'plan.pro.f3': 'Soporte prioritario',
		'plan.pro.cta': 'Registrarme',
		'plan.ent.tagline': 'Para cadenas y franquicias.',
		'plan.ent.f1': 'Soporte dedicado 24/7',
		...
		'ptable.r.roles': 'Roles de Cocina y Contabilidad',
	...
	en: {
		...
		'plan.starter.f2': 'Per-shift cash close',
		'plan.starter.f3': 'Kitchen & accounting roles',
		...
		'plan.pro.f2': 'Report export',
		'plan.pro.f3': 'Priority support',
		'plan.pro.cta': 'Sign up',
		'plan.ent.tagline': 'For chains and franchises.',
		'plan.ent.f1': '24/7 dedicated support',
		...
		'ptable.r.roles': 'Kitchen & accounting roles',
