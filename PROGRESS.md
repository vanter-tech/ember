...
- **System Health:** backend `./mvnw test` **1514/1514** (this session, `fix/pin-enumeration-rate-limit` off `main`). Frontend/`ember-hub/ui` last verified in the r534-538 batch: frontend `pnpm run build` clean, `ember-hub/ui` **34/34**.
