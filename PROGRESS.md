...
- **Current Active Task:** none in flight. **Next: HUB-BACKUP-RESTORE Task 5** (plan approved-pending; see Task Queue Status) - one task per context, `/clear` between. LIVE-BUG-BATCH is done (reports 495-504) on `fix/live-bug-batch-2026-09-18`, not yet PR'd/merged; hotfix 0.2.6.1 gates (r508) still pending.
