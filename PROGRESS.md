...
- **Current Active Task:** none in flight. **HUB-BACKUP-RESTORE code-complete; PR #133 merged, pom `0.2.7` (r518); pending (user-gated): run VERIFY 14-19 on `EmberHubSetup-0.2.7.exe`, tag `v0.2.7`, publish** (plan approved-pending; see Task Queue Status) - one task per context, `/clear` between. LIVE-BUG-BATCH is done (reports 495-504) on `fix/live-bug-batch-2026-09-18`, not yet PR'd/merged; hotfix 0.2.6.1 gates (r508) still pending.
