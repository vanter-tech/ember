...
- **System Health:** backend `./mvnw test` **1199/1199**; frontend `build` clean, `lint` 0 errors / 16 pre-existing warnings, `test:run` **118/118** (r411 verified); `landing` `pnpm build` clean (**26 pages**), ES/EN i18n parity 445/445.
